...
var place = dom(".place-name");
	place_position = dom(".place-position");
	details = dom(".details");
	list = dom(".list");
	prev = dom(".arrow-l");
	next = dom(".arrow-r");
	close = dom(".close");
	datails_name = dom(".datails-name");
	datails_write = dom(".datails-write")
...
//地图放大
var big_button = dom(".big-c");
	small_button = dom(".small-c");
	map_box_small = dom(".map-box-small");
	map_cqupt = dom(".map-cqupt");
	big_map = dom(".big-map-cqupt");
	masking = dom(".masking")
